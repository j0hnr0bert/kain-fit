-- Widen is_allowed_event_name() to accept the three quick-log reuse events
-- (recent_item_reused, favorite_used, saved_meal_reused). These were tracked
-- client-side under the wrong event name (saved_meal_repeated) because they
-- were never added to this allow-list; see QuickLogRail.tsx.
